...
- `--font-size-project-tech`: 프로젝트별 Tech 태그 글자 크기
...
## Project Tech Content Rule

- 프로젝트 하단 Tech에는 실제 사용이 확인된 기술만 넣는다.
- 역할명, UI 종류, 일반 설명을 기술명처럼 만들어 넣지 않는다.
- 작거나 세부적인 기술이라도 실제 사용했다면 표시할 수 있다.
- 각 기술은 개별 태그로 유지하며, 연한 회색 배경과 일반 굵기를 사용한다.
