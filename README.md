# 윤성준 | Android × Backend Developer

Kotlin과 Jetpack Compose로 사용자 경험을 만들고, 그 흐름이 네트워크·서버·데이터베이스까지 안정적으로 이어지는 방식을 고민해 온 개발자 윤성준입니다.
...
관상 분석 결과가 소개로 끝나지 않고 **궁합 매칭과 1:1 대화로 이어지는 사용자 여정**을 실제 앱 화면과 함께 정리했습니다.
...
웹 포트폴리오 소스는 [`gh-pages`](https://github.com/SSSSSungjun/portfolio/tree/gh-pages) 브랜치에서 확인할 수 있습니다.
